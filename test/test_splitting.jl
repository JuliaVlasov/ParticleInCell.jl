@testset "Operator Splitting" begin
  ...
  particle_info_ref = [ 11.780972450961723  5.4977871437821380;       
  ...
  grid = TwoDGrid( eta_min, eta_max, num_cells,
                   eta_min, eta_max, num_cells )
  ...
  particle_info_ref = [ 11.796703519422740  5.3443750893468831;
