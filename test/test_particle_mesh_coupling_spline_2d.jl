...
@testset "ParticleMeshCoupling 2D" begin
  ...
  v_grid[:,1,2] .= [ 7.0312500000000000E-002, 0.61197916666666663, 
  ...
  ParticleInCell.b_to_pp_2d!(ρ_dofs_pp, kernel.spline1, 
                             kernel.spline2, ρ_dofs)
  ...
  for i_part = 1:n_particles
     for i=1:4
        ...
        for j=1:4
           ...
           res = v_grid[i,1,i_part]*v_grid[j,2,i_part]*ρ_dofs_ref[i1+i2*n_cells+1]
