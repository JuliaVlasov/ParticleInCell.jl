...
struct ParticleMeshCoupling1D
    ...
    function ParticleMeshCoupling1D( mesh           :: OneDGrid, 
                                     no_particles   :: Int, 
                                     spline_degree  :: Int, 
        ...
        new(dims, delta_x, n_grid, n_dofs,
...
""" 
function evaluate_pp(p             :: ParticleMeshCoupling1D, 
                     position      :: Float64, 
...
"""
function evaluate(p          :: ParticleMeshCoupling1D, 
                  position   :: Float64, 
